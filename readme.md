...
-GET /api/sales//filter/[storeLocation]&[couponUsed]&[purchaseMethod]?pageSize=[pageSize]&page=[page]
-GET /api/sales/topItems
-GET /api/sales/satisfaction?pageSize=[pageSize]&page=[page]
